                            ...
                            <p class="excert">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <th scope="row"><img class="img-fluid pet_card_icon mr-2" src="<?php echo base_url('public')?>/assets/img/custom/favorite.png" alt="" width="30px" height="30px">區域編號</th>
                                        <td>Jacob</td>
                                        ...
                                        <tr>
                                        <th scope="row"><img class="img-fluid pet_card_icon mr-2" src="<?php echo base_url('public')?>/assets/img/custom/first-aid-kit.png" alt="" width="30px" height="30px">醫療</th>
                                        <td>Larry</td>
